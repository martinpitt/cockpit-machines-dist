...
return plural;
 ...
 "Attaching it will make this disk shareable for every VM using it.": [
  null,
  "Door deze aan te sluiten, wordt deze schijf deelbaar voor elke VM die deze gebruikt."
 ],
 "Automatic": [
  null,
  "Automatisch"
 ...
 "Automatically start libvirt on boot": [
  null,
  "Start libvirt automatisch tijdens het opstarten"
 ],
 ...
 "Connecting to virtualization service": [
  null,
  "Verbinding maken met Virtualisatie-service"
 ],
 "Connection": [
  null,
  "Verbinding"
 ...
 "Delete storage pool $0": [
  null,
  "Verwijder opslagpool $0"
 ],
 "Delete the volumes inside this pool": [
  null,
  "Verwijder de volumes in deze pool"
 ],
 ...
 "Disk $0 fail to get detached from VM $1": [
  null,
  "Schijf $0 kan niet worden losgekoppeld van VM $1"
 ],
 ...
 "Hours must be a number between 0 and 23": [
  null,
  "Uren moet een getal zijn tussen 0 en 23"
 ],
 "Hypervisor details": [
  null,
  "Hypervisor details"
 ...
 "Minutes must be a number between 0 and 59": [
  null,
  "Minuten moet een getal zijn tussen 0 en 59"
 ],
 "Mode": [
  null,
  "Modus"
 ...
 "Run unattended installation": [
  null,
  "Voer een installatie zonder toezicht uit"
 ],
 "Run when host boots": [
  null,
 ...
 "The $0 could not be deleted": [
  null,
  "De $0 kon niet verwijderd worden"
 ],
 "The VM is running and will be forced off before deletion.": [
  null,
  "De VM is actief en wordt vóór verwijdering uitgeschakeld."
 ],
 ...
 "The selected operating system does not support unattended installation": [
  null,
  "Het geselecteerde besturingssysteem ondersteunt geen installatie zonder toezicht"
 ],
 ...
 "This volume is already used by: ": [
  null,
  "Dit volume wordt al gebruikt door: "
 ],
 "Threads per core": [
  null,
  "Threads per kern"
 ...
 "Up to $0 $1 available on the default location": [
  null,
  "Tot $0 $1 beschikbaar op de standaard locatie"
 ],
 "Up to $0 $1 available on the host": [
  null,
  "Tot $0 $1 beschikbaar op de host"
 ],
 "Url": [
  null,
  "Url"
 ...
 "VM $0 failed to get deleted": [
  null,
  "VM $0 kan niet verwijderd worden"
 ],
