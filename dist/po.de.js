...
return plural;
 ...
 "Attaching it will make this disk shareable for every VM using it.": [
  null,
  "Durch das Einhängen der Platte wird Sie für jede VM die sie verwendet, freigegeben."
 ],
 "Automatic": [
  null,
  "Automatisch"
 ...
 "Delete the volumes inside this pool": [
  null,
  "Das Volume in diesem Pool löschen"
 ],
 ...
 "Leave the password blank if you do not wish to have a root account created": [
  null,
  "Lassen sie das Passwort leer, wenn sie keinen Root Account erstellen möchte"
 ],
 "Leave the password blank if you do not wish to have a user account created": [
  null,
  "Lassen sie das Passwort leer, wenn sie keinen Benutzer Account erstellen möchte"
 ],
 ...
 "The $0 could not be deleted": [
  null,
  "$0 konnte nicht entfernt werden"
 ],
 ...
 "VM $0 failed to get deleted": [
  null,
  "VM $0 konnte nicht gelöscht werden"
 ],
