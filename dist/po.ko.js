...
return plural;
 ...
 "Attaching it will make this disk shareable for every VM using it.": [
  null,
  "연결하면 이 디스크를 사용하는 모든 VM에서 공유할 수 있습니다."
 ],
 "Automatic": [
  null,
  "자동"
 ...
 "Clicking \"Launch remote viewer\" will download a .vv file and launch $0.": [
  null,
  "\"원격 표시기 시작\"을 누르면 .vv 파일을 내려받기 하여 $0를 시작합니다."
 ],
 "Clone": [
  null,
  "복제"
 ...
 "Deleting an inactive storage pool will only undefine the pool. Its content will not be deleted.": [
  null,
  "비활성화된 저장소 풀을 삭제하려면 풀 정의를 해제하면 됩니다. 내용는 삭제되지 않습니다."
 ],
 "Description": [
  null,
  "설명"
 ...
 "Detach the disks using this pool from any VMs before attempting deletion.": [
  null,
  "삭제를 시도하기 전에 VM에서 이 풀을 사용하여 디스크를 분리하십시오."
 ],
 "Detachable": [
  null,
  "분리 가능"
 ...
 "Disconnected from serial console. Click the connect button.": [
  null,
  "직렬 콘솔에서 연결이 끊어졌습니다. 연결 버튼을 눌러주세요."
 ],
 "Disk $0 fail to get detached from VM $1": [
  null,
  "디스크 $0 가 VM $1에서 분리되지 않음"
 ],
 ...
 "Error running semanage to discover system modifications": [
  null,
  "시스템 수정을 검색하기 위해 semanage 실행 중 오류 발생"
 ],
 "Excellent password": [
  null,
  "우수한 암호"
 ...
 "Failed to send key Ctrl+Alt+$0 to VM $1": [
  null,
  "Ctrl+Alt+$0키를 VM $1(으)로 보내지 못했습니다"
 ],
